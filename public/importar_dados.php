    ...
    <div class="container">
        ...
        <div class="main-content" id="main-content">
            <div class="titulo-secao">
                <span><a href="dashboard.php" class="home-link"><i class="fa-solid fa-house"></i></a>/ Dados do Google Forms</span>
            </div>

            <!-- Função para importar dados da planilha do Google -->
            <div class="container-importar">
                <h2>Importar Dados do Google Forms</h2>
                <form action="importar_dados.php" method="post">
                    <input type="text" name="url" placeholder="Cole a URL da planilha aqui" required>
