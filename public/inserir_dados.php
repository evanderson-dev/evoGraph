...
try {
    ...
    $sql = <<<SQL
        truncate table perguntas_formulario;
        truncate table respostas_formulario;
        ...
        -- ('Avaliacao_Geografia_2025', '1) Indique quais são os tipos de climas do Brasil [2]', 'Subtropical', 'EF07GE11'),
