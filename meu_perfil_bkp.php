...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["foto"]) && $_FILES["foto"]["error"] == 0) {
        ...
        $foto_name = $funcionario_id . "_" . time() . "." . pathinfo($_FILES["foto"]["name"], PATHINFO_EXTENSION);
...
<body>
    ...
    <section class="main">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a href="meu_perfil.php" class="sidebar-active"><i class="fa-solid fa-user-gear"></i>Meu Perfil</a>
        ...
        <div class="content" id="content">
            ...
            <section class="meu-perfil">
                ...
                <div class="profile-form">
                    <form method="POST" action="meu_perfil.php" id="profile-form" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group foto-placeholder">
                                ...
                                <input type="file" id="foto" name="foto" accept="image/*" disabled onchange="previewFoto(event)">
                            </div>
